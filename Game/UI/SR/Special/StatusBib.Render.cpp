...
VOID CStatusBib::RenderLines(FLOAT fOffsetX, FLOAT fOffsetY, UINT uDepthIndex) const
{
    FLOAT afPos[8];
...
VOID CStatusBib::RenderPoly(FLOAT fOffsetX, FLOAT fOffsetY, UINT uDepthIndex) const
{
    FLOAT afPos[8];
...
VOID CStatusBib::OnRender(FLOAT fOffsetX, FLOAT fOffsetY) const
{
